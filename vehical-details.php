...
$sql="INSERT INTO  tblbooking(BookingNumber,userEmail,VehicleId,FromDate,ToDate,driver,message,Status) VALUES(:bookingno,:useremail,:vhid,:fromdate,:todate,:driver,:message,:status)";
...
<title>Speed Rental Portal| Vehicle Details</title>
<!--Bootstrap -->
    ...
    <div class="row">
      <div class="col-md-9">
        <div class="main_features">
          <ul>
          <li> <i class="fa fa-automobile" aria-hidden="true"></i>
              <h5><?php echo htmlentities($result->vehicle_no);?></h5>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <textarea rows="4" class="form-control" name="message" placeholder="Purpose" required></textarea>
            </div>
            <div class="form-group">
            <label>Select Drivers:&nbsp;&nbsp;&nbsp;</label>
              <select class="selectpicker" name="drivername" required>
              <option value="Self-Drive">Self-Drive</option>
<?php $ret="SELECT driver_name from tbldrivers where driver_availability='yes'";
...
{
if($results->driver_name==$bdname) 
{
continue;
} else{
?>
<option value="<?php echo htmlentities($results->driver_name);?>"><?php echo htmlentities($results->driver_name);?></option>
<?php }}} ?>
